...
if __name__ == '__main__':
    ...
    sender_password = open('/workspaces/ProgramacionPython202506/Modulo5/token.txt').read().strip()

    receiver_email = 'gonzalo.delgado.r@uni.pe'
    subject = 'Re-envio Reporte Vinos'
    body = 'Adjunto lo solicitado'
    file_path = '/workspaces/ProgramacionPython202506/Modulo5/scripts/procesamiento/salida_argumento.csv'  # Cambia la ruta al archivo que quieras adjuntar
